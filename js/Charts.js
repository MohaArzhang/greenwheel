var pieChartLabel = [];
var element = document.getElementsByClassName('bikeType');
for (var i = 0, l = element.length; i < l; i++) {
    pieChartLabel[i] = element[i].value;
}
var pieChartData = [];
var element = document.getElementsByClassName('bikeCount');
for (var i = 0, l = element.length; i < l; i++) {
...
var barChartLabel = [];
var element = document.getElementsByClassName('bikeId');
for (var i = 0, l = element.length; i < l; i++) {
